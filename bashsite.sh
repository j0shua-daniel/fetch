...
echo -e "   ||               ||     \e[34mUptime\e[0m: $(uptime -p | sed 's/up //g')"
...
echo -e "\_______________________/  \e[34mFirmware Age\e[0m: $(hostnamectl | grep 'Firmware Age:' | sed 's/Firmware Age://g' | xargs)"
echo ""
